...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    // ------------------------------------------------
    // MOBILE
    // Do not run mouse/cursor effects on mobile
    // ------------------------------------------------
    if (!isDesktop) {
      return () => {
        tl.kill();
  ...
  return (
    ...
    >
      ...
      <div
        ref={contentRef}
        className="relative z-20 w-full max-w-7xl mx-auto px-5 sm:px-6 md:px-12 flex flex-col pt-24 sm:pt-28 lg:pt-24 pb-8 sm:pb-10 lg:pb-12"
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-7 sm:gap-10 lg:gap-8 py-6 sm:py-8 lg:py-0 lg:my-auto">
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-4 sm:space-y-5 text-left">
            ...
            {/* ROLE */}
            <div className="hero-anim-item flex flex-wrap items-center gap-2 sm:gap-3">
              ...
              <span className="text-white/80 text-[10px] sm:text-xs font-mono tracking-widest uppercase leading-relaxed">
                SOFTWARE DEVELOPER & OBSERVABILITY ENGINEER
              </span>
            ...
            {/* NAME */}
            <h1 className="hero-anim-item text-[11vw] sm:text-5xl md:text-7xl font-black tracking-tighter text-white leading-[0.95] break-words drop-shadow-[0_15px_30px_rgba(0,0,0,0.9)]">
            ...
            {/* TECHNOLOGIES */}
            <div className="hero-anim-item flex flex-wrap items-center gap-x-3 gap-y-2 text-[10px] sm:text-xs font-mono text-red-400 font-bold">
              ...
              <span>
                AWS • OpenTelemetry • Grafana • Python
              </span>
            ...
            <p className="hero-anim-item text-sm md:text-base text-white/80 font-light leading-relaxed max-w-md drop-shadow">
              ...
              Building modern web applications and cloud observability solutions using Python, AWS, OpenTelemetry, Grafana, and ClickHouse.
            ...
            <div className="hero-anim-item flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-2 w-full sm:w-auto">
              ...
              <a
                href="#contact"
                className="px-8 py-3.5 bg-neutral-900/80 text-white border border-white/20 font-bold text-xs uppercase tracking-widest rounded hover:bg-neutral-800 transition-all duration-300 shadow-xl backdrop-blur-md flex items-center justify-center gap-2 hover:scale-105 active:scale-95 w-full sm:w-auto"
              >
          ...
          <div className="lg:col-span-4 flex justify-center py-2 sm:py-4 lg:py-0 perspective-[1200px]">
            ...
            >
              ...
              <div className="relative w-[78vw] max-w-[320px] sm:w-[280px] md:w-[320px] p-3 bg-[#141414]/90 backdrop-blur-2xl rounded-2xl border border-red-600/40 shadow-[0_40px_80px_rgba(0,0,0,0.95)] overflow-hidden">
                ...
                <img
                  ...
                  className="w-full h-[88vw] max-h-[360px] sm:h-[330px] md:h-[390px] object-cover rounded-xl filter contrast-125 brightness-105 lg:group-hover:scale-[1.02] transition-transform duration-500"
                />
          ...
          <div className="hero-anim-item lg:col-span-3 flex flex-col items-start lg:items-end text-left lg:text-right mt-2 lg:mt-0">

            <div className="w-full max-w-none sm:max-w-xs p-5 bg-black/80 backdrop-blur-2xl border border-white/15 rounded-xl shadow-2xl">

              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold mb-2">
                Core Stack
              </h3>

              <p className="text-xs text-white/80 leading-relaxed font-light break-words">
                AWS • OpenTelemetry • Grafana • ClickHouse • Python • React
              </p>
        ...
        <div className="hero-anim-item flex items-center justify-center sm:justify-between gap-2 text-[9px] sm:text-xs font-mono text-white/50 tracking-widest uppercase text-center w-full pt-2 pb-2">
      ...
      <header className="absolute top-0 left-0 z-50 w-full max-w-7xl mx-auto px-5 sm:px-6 md:px-12 py-6 flex items-center justify-between pointer-events-auto">
