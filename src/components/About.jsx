          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                ...
                , an aspiring Software Developer with a strong interest in web development, cloud technologies, and observability.

              </p>

              <p className="text-sm md:text-base text-white/60 font-light leading-relaxed">

                I enjoy building practical applications, working with modern development tools, and exploring cloud-based monitoring and observability solutions.
              ...
              <ul className="space-y-3.5 text-sm text-white/80 font-light">
                ...
                <li className="flex items-start gap-2.5">
                  ...
                  <span>
                    Worked with{' '}
                    <strong className="text-white">
                      OpenTelemetry, Grafana, Prometheus and ClickHouse
                    </strong>.
                  </span>
                </li>
          ...
          >
            ...
            <div className="space-y-2 text-left relative z-10">
              ...
              <p className="text-base md:text-lg font-semibold text-white">
                Technologies I use to build, monitor, and improve modern applications.
              </p>
